---
title: "Research training in the MIND Lab"
format: 
  html:
    toc: true
---
...
The seminars are open to all students in the lab, and attendance is expected for those who are actively involved in research projects. We will assign projects each semester and we will plan around your capacity and availability on a case-by-case basis.

Room TBC - will be added soon.
...
The first set of badges are:

- Lab engagement badge: awarded for regular attendance and active participation in lab meetings and discussions. This shows that you contributed to the lab culture.

- Literature reading and review badge: awarded for participation and contribution to paper review sessions.

- Research presentation badge: awarded for delivering a presentation in a lab meeting.

- Lab data collection badge: awarded for collection of participant data in a lab-based project.

- Online data collection badge: awarded for online collection of participant data in a project.

- Data analysis badge: awarded for completion of at least 1 training session on data analysis and contribution to data analysis for at least 1 project.

- Open Science Badge: awarded for completion of introduction to Open Science Framework training and contribution to 1 lab project on OSF.

- Eyetracker badge: awarded for completion of eyetracker training and eyetracker data collection on 1 project.

- fNIRS badge: awarded for completion of fNIRS training and fNIRS data collection on 1 project.

- Academic Writing badge: awarded for author contribution to a lab research article. 
-->


## Training sessions: Core skills for cognitive psychology and neuroscience research
...
## Advanced skills for cognitive psychology and neuroscience research
