...
4. Brain imaging demonstration 

# How do do psychology researchers tackle complex problems?  {background-image="assets/complex.png"}

# {background-image="assets/psychology.png" background-repeat="contain"}
...
4. fNIRS is one of our neuroimaging tools to examine the brain during behaviour / cognition
